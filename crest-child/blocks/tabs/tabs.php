        ...
        <div class="column-75 center">
            <div class="tabs_wrapper"> 
                ...
                <?php while( have_rows('tab_content') ): the_row(); ?> 
                    <li <?php if($n==1) { ?>class="tab-active"<?php } ?> rel="tab<?php echo $n; ?>"><?php the_sub_field('tab_title'); ?></li>
                    <?php $n++; ?>
                <?php endwhile; ?>
                <?php endif; ?> 
                </ul>
                ...
                <?php while( have_rows('tab_content') ): the_row(); ?> 
                    <div id="tab<?php echo $i; ?>" class="tab_content">
                        ...
                        <?php } ?>
                            <div class="tab-copy">
                                <p class="tab-header"><?php the_sub_field('tab_title'); ?></p>
                                <p class="subtitle"><?php the_sub_field('tab_content_headline'); ?></p>
