    ...
    <div class="wp-block-group__inner-container is-layout-constrained wp-block-group-is-layout-constrained">
        <div class="wp-block-columns is-layout-flex wp-container-core-columns-is-layout-9d6595d7 wp-block-columns-is-layout-flex">
            <div class="wp-block-column overlay-behind is-layout-flow wp-block-column-is-layout-flow" style="width:66%">
                <figure class="wp-block-image size-full image-full extra-wide-img">
                    <picture decoding="async" class="wp-image-2108">
            ...
            <div class="wp-block-column offset-right align-center-vertical is-layout-flow wp-block-column-is-layout-flow" style="width:33%">
